...
from apps.PERSONAS.personas_rucPersonas.serializers import (
        ...
        try:
            ...
            if rucPersona is not None:
                if rucPersona.identificacion != request.data['identificacion']:
                    ...
                    query = RucPersonas.objects.filter(identificacion=request.data['identificacion'],ruc=request.data['ruc'],state=1).first()
