...
from .views.negocio_views import (
...
from .views.direccion_establecimiento_views import (
...
# Esta variable se utiliza para colocar el nombre aplicacion de negocios
app_name = 'negocios'
