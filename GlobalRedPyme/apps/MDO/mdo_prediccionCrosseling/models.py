...
class PrediccionCrosseling(models.Model):
    ...
    def save(self, *args, **kwargs):
        return super(PrediccionCrosseling, self).save(*args, **kwargs)

class Detalles(models.Model):
    prediccionCrosseling = models.ForeignKey(PrediccionCrosseling, related_name='detalles', null=True, blank=True, on_delete=models.DO_NOTHING)  # Relacion Factura
