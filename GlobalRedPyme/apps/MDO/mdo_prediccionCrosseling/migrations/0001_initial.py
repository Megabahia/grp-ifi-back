# Generated by Django 3.1.7 on 2022-02-23 01:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True)),
                ('state', models.SmallIntegerField(default=1)),
                ('prediccionCrosseling', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='detalles', to='mdo_prediccionCrosseling.prediccioncrosseling')),
            ],
        ),
    ]
